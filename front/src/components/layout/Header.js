    ...
    <Fragment>
      <nav className="navbar row">
        ...
        {user ? (
          ...
          <><div className="col-md-1">
            <div className='dropdown-menu' aria-labelledby='dropDownMenu'>
              ...
              {user && user.role === "admin" && (
                <Link className="dropdown-item" to="/productos">Adm. Products</Link>
              )}
          ...
          </div><div className="col-12 col-md-6 mt-2 mt-md-0">
            </div><div className="col-12 col-md-3 mt-4 mt-md-0 text-center">
